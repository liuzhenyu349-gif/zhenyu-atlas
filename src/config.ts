...
export const projectsPageContent: ProjectPageContent = {
  ...
  projects: [
    { title: "Survey Data Quality Inspector", description: "A Python web tool that turns fourth-order leveling data into route calculations, quality status, anomaly reports and interactive charts, with explicit limits for learning and assisted checking.", image: "/project-previews/survey-data-inspector.svg", imageAlt: "Survey Data Quality Inspector 的完整深蓝色数据面板示意图", previewNote: "Illustrative preview · Open project ↗", year: "2026", field: "Surveying · Python", status: "Prototype", url: "/projects/survey-data-inspector/" },
